...
export function CoachRegistration() {
  ...
  const handleSubmit = async () => {
    for (const key in formData) {
      ...
      try {
        const response = await axios.post("http://localhost:4568/user/register", formData);
...
//     // Your existing code for rendering additional fields for coach registration
//   };
